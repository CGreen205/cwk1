...
void cGame::initialise(SDL_Window* theSDLWND, SDL_Renderer* theRenderer)
{
	...
	// Store the textures
	textureName = { "asteroid1", "asteroid2", "asteroid3", "asteroid4", "bullet","theMan","theBackground"};
	texturesToUse = { "Images\\asteroid1.png", "Images\\asteroid2.png", "Images\\asteroid3.png", "Images\\asteroid4.png", "Images\\bullet.png", "Images\\Running.png", "Images\\Track Start.png"};
	...
	gameTextList = { "Hurdle Game", "[Start Game]"};
	...
	theTextureMgr->addTexture("StartGame", theFontMgr->getFont("Gameplay")->createTextTexture(theRenderer, gameTextList[1], SOLID, { 0, 255, 0, 255 }, { 0, 0, 0, 0 }));
	...
	theRocket.setSpritePos({ 490, 500 });
	theRocket.setTexture(theTextureMgr->getTexture("theMan"));
	theRocket.setSpriteDimensions(theTextureMgr->getTexture("theMan")->getTWidth(), theTextureMgr->getTexture("theMan")->getTHeight());
